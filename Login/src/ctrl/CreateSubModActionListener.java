...
public class CreateSubModActionListener implements ActionListener {
	...
	public void refreshMenu(String itemValue) {
		 ...
		 * module.setUpdate(CreateSubModBean.UPDATE_AJAX);
		 * module.setValue(CreateSubModBean.MODULE); module.addActionListener(back);
		 ...
		 * Submenu(); submenu.setLabel(CreateSubModBean.FAECHER);
		 * model.addSubmenu(submenu);
		 * 
