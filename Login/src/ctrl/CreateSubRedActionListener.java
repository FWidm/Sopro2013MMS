...
import server.CreateSubRedBean;
...
public class CreateSubRedActionListener implements ActionListener {
	...
	public void refreshMenu(String itemValue) {
		 ...
		 * module.setUpdate(CreateSubRedBean.UPDATE_AJAX);
		 * module.setValue(CreateSubRedBean.MODULE); module.addActionListener(back);
		 ...
		 * Submenu(); submenu.setLabel(CreateSubRedBean.FAECHER);
		 * model.addSubmenu(submenu);
		 * 
