...
import de.mms.ctrl.StartActionListener;
...
public class StartBean {
	...
	public static final String UPDATE_AJAX = "list-menu-start back-menu-start scrollPanel-start";
	...
	public StartBean() {
		...
		for (int i = 0; i < exRulesList.size(); i++) {
			...
			m.addActionListener(new StartActionListener());
