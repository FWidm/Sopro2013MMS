...
import de.mms.server.CreateModRedBean;



public class CreateModRedActionListenerBack implements ActionListener {
	
	public void refreshMenu(String itemValue) {
		
		CreateModRedActionListener listener = new CreateModRedActionListener();
		
		CreateModRedBean bean = findBean("CreateModRedBean");
		
		if(itemValue.equals(CreateModRedBean.PRUEFORDNUNG)) {
			...
			submenu.setLabel(CreateModRedBean.PRUEFORDNUNG);
		...
		else if(itemValue.equals(CreateModRedBean.MODMANUAL)) {
		...
		else if(itemValue.equals(CreateModRedBean.MODULE)) {
