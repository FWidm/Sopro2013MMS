...
public class User {
	...
	public User(String email, String name, String firstname, String role,
		...
		// Randompassword
		String generatedPass = de.mms.util.PasswordGen.generatePassword(length);
		...
		try {
			this.password = de.mms.util.PasswordHash.createHash(generatedPass);
